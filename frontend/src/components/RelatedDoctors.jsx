...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <div className="px-6 sm:px-12 py-16 bg-gradient-to-b from-white to-blue-50/20">
      {/* Heading */}
      <div className="text-center mb-12 max-w-2xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
          Related <span className="text-blue-600 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Doctors to Book</span>
        </h1>
        <p className="text-gray-500 mt-3 text-base sm:text-lg">
          Browse other matching specialists in the same medical department.
        </p>
      ...
      {/* View More Specialists button if needed */}
